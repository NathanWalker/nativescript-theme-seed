...
if (fs.existsSync("nativescript-theme-yours")) {
    deleteFolderRecursive("nativescript-theme-yours");
}
fs.mkdirSync("nativescript-theme-yours");
fs.mkdirSync("nativescript-theme-yours/css");
fs.mkdirSync("nativescript-theme-yours/scss");
fs.mkdirSync("nativescript-theme-yours/fonts");
...
// Copy our Package
copyFile("./nativescript-theme-yours.json", "./nativescript-theme-yours/package.json");

// Copy our Readme
copyFile("./nativescript-theme-yours.md", "./nativescript-theme-yours/readme.md");

console.log("Change to the 'nativescript-theme-yours' folder and you can now do your `npm publish`");
...
function copyFonts() {
    ...
    for (i = 0; i < ttfFiles.length; i++) {
        out = ttfFiles[i].replace("./app/", "./nativescript-theme-yours/");
        // Skip font Awesome
    ...
    for (i = 0; i < otfFiles.length; i++) {
        out = otfFiles[i].replace("./app/", "./nativescript-theme-yours/");
        // Skip font Awesome
        if (out.indexOf("fontawesome") !== -1) {
            continue;
        }
...
function copySCSS() {
    ...
    for (var i = 0; i < sassFiles.length; i++) {
        var out = sassFiles[i].replace("./app/", "./nativescript-theme-yours/");
        ...
        if (paths.length > 1) {
            var path = "./nativescript-theme-yours";
...
function parseSass(sassFile, importPaths) {
    ...
    var outputFile = "nativescript-theme-yours/css";
